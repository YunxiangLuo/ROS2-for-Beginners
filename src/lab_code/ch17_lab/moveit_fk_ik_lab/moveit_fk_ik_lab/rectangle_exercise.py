#!/usr/bin/env python3
"""Completed rectangle exercise using MoveIt's Cartesian path service."""
...
class MoveItRectangleDemo(Node):
    ARM_GROUP = "xarm"
    END_EFFECTOR_LINK = "gripper_centor_link"
    REFERENCE_FRAME = "base_link"

    def __init__(self):
        super().__init__("moveit_rectangle_demo")
        self.moveit = MoveItPy(node_name="moveit_rectangle_demo_moveit")
