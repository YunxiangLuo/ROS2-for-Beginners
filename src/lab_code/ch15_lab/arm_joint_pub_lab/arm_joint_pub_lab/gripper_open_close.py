...
class GripperOpenClose(Node):
    ...
    def publish_joint_states(self):
        ...
        if self.forward and self.js.position[6] <= 0.65:
            self.js.position[6] += 0.015
            self.js.position[7] += 0.015
        elif self.js.position[6] >= 0:
            self.forward = False
            self.js.position[6] -= 0.015
            self.js.position[7] -= 0.015
        else:
